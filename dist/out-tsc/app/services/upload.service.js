...
var UploadService = (function () {
    ...
    UploadService.prototype.createUser = function (data) {
        var headers = new Headers({ 'Content-Type': 'application/json' });
        var options = new RequestOptions({ headers: headers });
        var _path = 'https://www.googleapis.com/upload/drive/v2/files;';
...
//# sourceMappingURL=../../../../src/app/services/upload.service.js.map